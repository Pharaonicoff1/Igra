...
export const CFG = {
  ...
  spin: {
    ...
    ramp: 0.2,            // с: плавный переход множителя, ease-in-out, в обе стороны
    flashTime: 0.35,      // с: вспышка на планете в момент спада буста
    flashRadius: 26,      // px: насколько разрастается кольцо вспышки
